...
fun MoreScreen(
    ...
    val viewList: List<MoreItemData> = listOf(
        MoreItemData(1,"Feeds",R.drawable.feeds_icon,"FeedsScreen/${userLoginData.email}",mapOf()),
        MoreItemData(2,"Employee Information",R.drawable.employee_information,"",
            mapOf("Colleagues" to "ColleaguesScreen/${userLoginData.email}","Employee Details" to "EmployeeDetailsScreen/${userLoginData.email}")),
        MoreItemData(3,"Attendance",R.drawable.attendance,"",
            mapOf("View" to "AttendanceComposableView","Regularization" to "LeaveRegularisationScreen/${userLoginData.email}/${userLoginData.username}/${userLoginData.emp_Id}")),
        ...
        MoreItemData(6,"Leave Tracker",R.drawable.leave_tracker,"",
            mapOf("View" to "LeaveTrackerComposableView/${userLoginData.email}","Compensatory Request" to "ApplyCompOffScreen/${userLoginData.email}","Holidays" to "UpcomingHolidaysScreen")),
