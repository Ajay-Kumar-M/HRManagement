...
//            }
    ...
    fun fetchLeaveRequestsData(){
        ...
        numberOfFetchProcess++
        appDataManager.fetchLeaveLogs(2025, appUserData.email, 0) { querySnapshot, response, documentSnapshot ->
    ...
    fun fetchFeedData(){
        ...
        numberOfFetchProcess++
        appDataManager.getUserFeeds(appUserData.email) { querySnapshot, response ->
